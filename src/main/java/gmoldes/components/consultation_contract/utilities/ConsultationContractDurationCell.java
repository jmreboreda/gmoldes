...
public class ConsultationContractDurationCell extends TableCell<ConsultationContractDataTableDTO, Duration> {

    private TextField textField;

    public ConsultationContractDurationCell() {}
...
//
//                }else
                if(timePatternHHmm.matcher(textField.getText()).matches()) {
                    try {
                        if(LocalTime.parse(textField.getText(), timeFormatter).isBefore(LocalTime.MAX)){
                            try {
                                commitEdit(Utilities.converterTimeStringToDuration(textField.getText()));
                            }
    ...
    private String getString() {
        return getItem() == null ? null : Utilities.converterDurationToTimeString(getItem());
    }
}
