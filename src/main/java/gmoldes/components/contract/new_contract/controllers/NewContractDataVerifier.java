...
public class NewContractDataVerifier {
    ...
    public static Boolean verifyContractParts(ContractParts contractParts, TabPane tabPane){
        ...
        if(contractParts.getSelectedCCC() == null){
            if(!Message.confirmationMessage((Stage) tabPane.getScene().getWindow(), Parameters.SYSTEM_INFORMATION_TEXT, ContractVerifierConstants.QUESTION_NULL_CCC_CODE_IS_CORRECT)){
                return false;
            }
        }
